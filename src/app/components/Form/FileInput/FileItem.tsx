      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="font-medium text-error-700 text-sm dark:text-error-400">
          ...
          <button
            type="button"
            className="font-semibold text-error-700 text-sm hover:text-error-900 dark:text-error-400 dark:hover:text-error-300"
          >
            Try again
          </button>
        </div>
